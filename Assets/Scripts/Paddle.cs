...
public class Paddle : MonoBehaviour {
    ...
    private void FixedUpdate()
    {
        ...
        //distancia que se ha movido el remo el ultimo cuadro, negativo empuja el kayak hacia adelante
        ...
        if (transform.position.y < _waterLevel.y)
        {
            ...
            if (lastPos != Vector3.zero)
            {
                ...
                //thrust *= Mathf.Clamp01((transform.position.y - _waterLevel.y)*(-0.5f));
                ...
                //si el remo se mueve lento, rotar pal otro lao? no se
                //if (magnitude > RotationBias){side *= -1;} 
